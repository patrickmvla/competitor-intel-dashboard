...
export const PriceDropAlertEmail: React.FC<Readonly<PriceDropAlertEmailProps>> = ({
  productName,
  competitorName,
  oldPrice,
  newPrice,
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', padding: '20px', backgroundColor: '#f4f4f4' }}>
      <div style={{ maxWidth: '600px', margin: 'auto', backgroundColor: 'white', padding: '20px', borderRadius: '8px' }}>
        ...
        <p>A significant price drop has been detected for a product you are tracking.</p>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <p>
            ...
            <span style={{ textDecoration: 'line-through', color: '#999' }}>${oldPrice.toFixed(2)}</span> → 
            <strong style={{ color: '#28a745' }}> ${newPrice.toFixed(2)}</strong>
          </p>
